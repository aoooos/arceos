...
pub fn test_csr_register() {
    ...
    //unsafe { asm!("addi.d {d}, {d}, -1",d=inout(reg)dir3) };
    ...
    //unsafe { asm!("addi.d {d}, {d}, -1",d=inout(reg)dir2) };
    ...
    //unsafe { asm!("addi.d {d}, {d}, -1",d=inout(reg)dir1) };
    ...
    //unsafe { asm!("addi.d {d}, {d}, -1",d=inout(reg)pt) };
